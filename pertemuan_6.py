...
# --- Langkah 1: Muat dan Bagi Data (MODIFIKASI) ---
...
# MODIFIKASI: Data terlalu kecil untuk 3 split. Cukup bagi 2.
# Validation set akan disimulasikan oleh Cross-Validation.
...
# Tidak ada evaluasi di validation set, kita akan gunakan Cross-Validation
...
# Gunakan pipeline yang sama, tapi parameter grid hanya untuk classifier
param_grid = {
...
plt.show() # Menampilkan plot jika dijalankan secara interaktif
